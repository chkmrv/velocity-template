...
<script src="/rrwebRootMainTemplate-theme/js/babel-core.min.js"></script>
<script type="text/javascript" src="/rrwebRootMainTemplate-theme/js/require.js"></script>
		...
		<div id="top_panel">
			...
			<div id="top_location" class="top_location js-openContainer" style="position: relative;">
				<%
					...
					boolean cookieDefaultValueNotEmpty = false;
				...
				for(Cookie cookie : cookies) {
					if ("liferay_regionId".equals(cookie.getName())) {
						cookieDefaultValueNotEmpty = true;
				...
				if(!cookieDefaultValueNotEmpty) {
					currentRegionName = "Москва";
					currentRegionId = "25918";
                }
				%>
