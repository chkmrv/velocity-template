					...
					!edit ? _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('input', { className: 'form-control',
									type: 'number',
									value: developedOperation.category,
									onChange: function onChange(e) {
										var obj = developedOperation;
										obj.category = Number(e.target.value);
		...
		function LiveSituationsStandards(props) {
			...
			_this.saveStandard = function () {
				...
				var tests = {
					...
					paymentTitle: {
						approve: developedStandard.paymentTitle.length <= 0,
						descr: "Введите заголовок платежа"
					},
					paymentPrivate: {
					...
					!edit ? _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								{ className: 'col-xs-12' },
								_react2.default.createElement('input', { className: 'form-control',
									value: developedStandard.paymentTitle,
									onChange: function onChange(e) {
										var obj = developedStandard;
										obj.paymentTitle = e.target.value;

										_this2.setState({ developedStandard: obj });
									}
								})
							),
							errors['paymentTitle'] ? _react2.default.createElement(
								'div',
								{ className: 'clearfix col-xs-12' },
								_react2.default.createElement(
									'span',
		...
		function LiveSituationsDocuments(props) {
			...
			_this.saveDocument = function () {
				...
				var tests = {
					...
					documentGroup: {
						approve: developedDocument.documentGroup.length <= 0,
						descr: "Введите номер категории"
					},
					objectIds: {
					...
					!edit ? _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('input', { className: 'form-control',
									type: 'number',
									value: developedDocument.documentGroup,
									onChange: function onChange(e) {
										var obj = developedDocument;
										obj.documentGroup = Number(e.target.value);

										_this2.setState({ developedDocument: obj });
									}
								})
							),
							errors['documentGroup'] ? _react2.default.createElement(
								'div',
								{ className: 'clearfix col-xs-12' },
								_react2.default.createElement(
									'span',
